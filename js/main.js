...
-----------------------------------*/
  $('nav#dropdown').meanmenu({
    siteLogo: "<a href='index.html'><img src='img/logo/param-hansa-values-logo.png' width='60%' /></a>"
  });  
/*---------------------------
 Counter Up
 ----------------------------*/
...
if($('#contact-form').length){
    $('#contact-form').validator().on('submit', function (e) {
       ...
       if (e.isDefaultPrevented()) {
          $target.html("<div class='alert alert-danger'><p>Please fill in all the details in the form.</p></div>");
       } else {
        ...
        // ajax call
         $.ajax({
           ...
           success: function( text ){
                  if(text == "success"){
                      $this[0].reset();
                      $target.html("<div class='alert alert-success'><p>Your message has been sent. Thank you.</p></div>");
                  } else {
